...
import com.bank.profile.services.interfaces.AccountDetailsIdService;
...
public class AccountDetailsIdControllerTest {
    ...
    private static AccountDetailsIdDto dto = new AccountDetailsIdDto();
    private static AccountDetailsId model = new AccountDetailsId();
    private static final String PATH = "/account_details_id";
